...
public class ProductDaoImpl implements ProductDao {
	...
	public boolean addProduct(Product product) {
		String sql="insert into product (pname,pdescription,price,ccategory) values (?,?,?,?)";
		try {
	...
	public List<Product> getAllProduct(String category) {
		List<Product> pl=new ArrayList<>();
		String sql="select * from product where ccategory=?";
		try {
			PreparedStatement ps=con.prepareStatement(sql);
	...
	public List<String> getAllCategory(){
		...
		String sql="select distinct ccategory from product";
		try {
			PreparedStatement ps=con.prepareStatement(sql);
			ResultSet rs=ps.executeQuery();
			while(rs.next()) {
