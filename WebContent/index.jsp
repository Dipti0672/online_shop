...
<title>*Online Shopping.com*</title>

<!-- Bootstrap core CSS -->
<link href="resources/css/bootStrapMin.css" rel="stylesheet">

<!-- Custom styles for this template -->
<link href="resources/css/shopHome.css" rel="stylesheet">
...
<body>
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="#"><img class="card-img-top card_img--fix-height"
								src="resources/images/<%=p.getPname()%>.jpg" alt=""></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="#"><%=p.getPname()%></a>
								</h4>
								...
								<c:if test="${userName!=null }">
									<h5>
										<a href="CartServlet?action=addToCart&pid=<%=p.getPid()%>">Add To Cart</a>
									</h5>
								</c:if>
								<p class="card-text">
									<%=p.getPdescription()%>
	...
	<script src="resources/js/bootStrapBundle.js"></script>
